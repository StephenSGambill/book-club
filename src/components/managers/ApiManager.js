...
export const getMemberByEmail = (email) => {
    return fetch(`http://localhost:8000/members?email=${email}`)
        .then(res => res.json())
}

export const getMemberByUsername = (username) => {
    return fetch(`http://localhost:8000/members?username=${username}`, {
        headers: {
...
export const setNewClubMember = (memberObject) => {
    return fetch("http://localhost:8000/clubMembers", {
        method: "POST",
        headers: {
...
export const deleteClubMember = (clubMemberId) => {
    return fetch(`http://localhost:8000/clubMembers/${clubMemberId}`,
        { method: "DELETE" })
}
...
export const updateBookInfo = (book) => {
    return fetch(`http://localhost:8000/books/${book.id}`, {
        method: "PUT",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Token ${getToken()}`
...
export const getBookById = (id) => {
    return fetch(`http://localhost:8000/books?&id=${id}`)
        .then(res => res.json())
}
...
export const getBookByChapter = (chapterId) => {
    return fetch(`http://localhost:8000/bookChapters?&id=${chapterId}&_expand=book`)
        .then(res => res.json())
}
...
export const getChaptersByBook = () => {
    return fetch(`http://localhost:8000/bookChapters`)
        .then(res => res.json())
}

export const getChaptersByBookId = (bookId) => {
    return fetch(`http://localhost:8000/bookChapters?&bookId=${bookId}`)
        .then(res => res.json())
}

export const updateBookChapterTitle = (bookChapters) => {
    bookChapters.map(chapter => {
        return fetch(`http://localhost:8000/bookChapters/${chapter.id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Token ${getToken()}`
...
export const getChapterComments = (id) => {
    return fetch(`http://localhost:8000/chapterComments?&bookChapterId=${id}`)
        .then(res => res.json())
}
...
export const deleteComment = (commentId) => {
    return fetch(`http://localhost:8000/chapterComments/${commentId}`,
        { method: "DELETE" })
}

export const setNewChapterComment = (commentInfo) => {
    return fetch(`http://localhost:8000/chapterComments`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Token ${getToken()}`
...
export const updateClubInfo = (clubInfo) => {
    return fetch(`http://localhost:8000/clubs/${clubInfo.id}`, {
        method: "PUT",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Token ${getToken()}`
...
export const getClubs = () => {
    return fetch(`http://localhost:8000/clubs?&_expand=book`, {
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Token ${getToken()}`
        }
...
export const getClubMembers = () => {
    return fetch(`http://localhost:8000/clubMembers?&_expand=member`)
        .then(res => res.json())
}


export const getClubMembersAndClub = () => {
    return fetch(`http://localhost:8000/clubMembers?&_expand=club`)
        .then(res => res.json())
}

export const getClubMemberById = (id) => {
    return fetch(`http://localhost:8000/clubMembers?&_expand=club&memberId=${id}`)
        .then(res => res.json());
};
...
export const getBookClubById = (id) => {
    return fetch(`http://localhost:8000/clubs?&id=${id}`)
        .then(res => res.json())
}
